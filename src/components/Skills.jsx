        ...
        <div name="skills" className='bg-[#0a192f]'>
            ...
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                <div>
                    ...
                    <p className='text-lg sm:text-2xl py-4 text-gray-300'>these are the technologies i've worked with</p>
                </div>


                <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8 text-gray-300'>
                    <div className='h-[150px] text-xl  justify-end items-center flex flex-col shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
